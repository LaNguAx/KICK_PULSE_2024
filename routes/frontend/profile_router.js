...
import { mustLogin } from '../../controllers/auth_Controller.js'; // Ensure you import mustLogin if it's needed here
...
router.route('/profile/settings').get(mustLogin, getSettingsIndex);
